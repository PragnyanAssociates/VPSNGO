...
// Assuming these components are in the same directory or correctly pathed
import TeacherNotifications, { initialNotificationsData } from './TeacherNotifications';
import TeacherProfile from './TeacherProfile';
import AcademicCalendar from './AcademicCalendar';
import TeacherHI from './TeacherHI'; // IMPORT StudentHealth
...
const TeacherDashboard = ({ navigation }) => {
  ...
  const renderContent = () => {
      ...
      case 'allNotifications':
        return (
          <>
            ...
            <TeacherNotifications onUnreadCountChange={handleUnreadCountChange} />
          </>
        );
      case 'calendar':
        return <AcademicCalendar />; // Assuming AcademicCalendar might have its own header or none
      case 'profile':
        return <TeacherProfile userProfile={userProfile} onUpdateProfile={setUserProfile} />;
      case 'TeacherHI':
        return (
          <>
            <ContentScreenHeader title="Health Information" />
            <TeacherHI />
            {/* Pass studentId={userProfile.studentId} if TeacherHealth component uses it */}
          </>
        );
    ...
    //     );
        ...
        return (
          <>
            <ContentScreenHeader title="Communictions" />
            <TeacherCL />
            {/* Pass studentId={userProfile.studentId} if Students Home Work component uses it */}
          </>
        );
