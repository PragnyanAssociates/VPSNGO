...
const StudentResultsScreen = ({ navigation }) => {
    ...
    const handleDownload = (reportId) => {
        // Here you would navigate to a new screen that renders the full marksheet
        // and provides a "Download as PDF" option.
                ...
                ListHeaderComponent={
                    <View style={styles.header}>
                        ...
                        <View style={{ marginLeft: 15 }}>
                            <Text style={styles.headerTitle}>Progress Reports for Student</Text>
                            <Text style={styles.headerSubtitle}>View and download term-wise progress reports.</Text>
                        </View>
                    </View>
                }
...
const styles = StyleSheet.create({
    ...
    headerSubtitle: { fontSize: 14, color: '#546e7a', marginTop: 2 },
    card: { backgroundColor: '#fff', borderRadius: 12, marginHorizontal: 15, marginVertical: 10, padding: 20, elevation: 3, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 5 },
    cardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    cardTitle: { fontSize: 18, fontWeight: 'bold', color: '#333', marginLeft: 10 },
    cardDate: { fontSize: 13, color: '#777', marginBottom: 15 },
    detailRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10 },
    detailLabel: { fontSize: 15, fontWeight: '500', color: '#333', marginLeft: 10 },
    detailValue: { fontSize: 15, color: '#1b5e20', fontWeight: 'bold', marginLeft: 5 },
    commentBox: { backgroundColor: '#f9f9f9', padding: 12, borderRadius: 8, marginTop: 5, borderWidth: 1, borderColor: '#eee' },
    commentText: { fontSize: 14, color: '#444', lineHeight: 20 },
    downloadButton: { flexDirection: 'row', backgroundColor: '#1976d2', paddingVertical: 12, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginTop: 20 },
